...
require.register("client/js/data.js", function(exports, require, module) {
"use strict";
...
require.register("client/js/initialize.js", function(exports, require, module) {
'use strict';
...
$(function () {
  $('body').append(_data2.default.name);
  console.log(_data2.default.name);
});
});
